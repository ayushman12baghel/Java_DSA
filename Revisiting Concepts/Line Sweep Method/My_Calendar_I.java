...
// Approach 1 Using TreeMap O(logn)
class MyCalendar {
    ...
    public boolean book(int startTime, int endTime) {
        Integer prevStart = events.floorKey(startTime);
        if (prevStart != null && events.get(prevStart) > startTime) {
            return false;
        }
...
// Approach 2 Using Line Sweep Method O(n)
class MyCalendar {
    TreeMap<Integer, Integer> events;
